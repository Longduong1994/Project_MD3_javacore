...
public class InputMethods {
    private static final String ERROR_ALERT = "===>> Invalid format, or out of range! Please try again....";
    private static final String EMPTY_ALERT = "===>> Cannot be left blank. Please re-enter....";
    /*========================================Input Method Start========================================*/
